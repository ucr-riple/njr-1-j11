 ...
 *
 */
public abstract class AbstractGenericOnOffSetTreeNode<V, N extends AbstractGenericOnOffSetTreeNode<V, N>>
extends AbstractGenericSetTreeNode<V, N> implements OnOffTreeNodeInterface<N> {
	 ...
	 * @param value
	 */
	public AbstractGenericOnOffSetTreeNode(Comparator<? super N> comparator, V value) {
	 ...
	 * @param value
	 */
	public AbstractGenericOnOffSetTreeNode(V value) {
		super(value);
		base = new OnOffTreeNodeBase<>(internalGetThis());
	}
