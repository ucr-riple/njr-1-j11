 ...
 *
 */
public abstract class AbstractGenericOnOffKeySetTreeNode<K, V, N extends AbstractGenericOnOffKeySetTreeNode<K, V, N>>
extends AbstractGenericKeySetTreeNode<K, V, N> implements OnOffTreeNodeInterface<N> {
	 ...
	 * @param value
	 */
	public AbstractGenericOnOffKeySetTreeNode(Comparator<? super K> keyComparator,
	 ...
	 * @param value
	 */
	public AbstractGenericOnOffKeySetTreeNode(K key, V value) {
		super(key, value);
		base = new OnOffTreeNodeBase<>(internalGetThis());
	}
