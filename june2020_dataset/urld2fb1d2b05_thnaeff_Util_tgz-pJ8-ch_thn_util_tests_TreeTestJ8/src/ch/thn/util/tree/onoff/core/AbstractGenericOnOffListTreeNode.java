 ...
 *
 */
public abstract class AbstractGenericOnOffListTreeNode<V, N extends AbstractGenericOnOffListTreeNode<V, N>>
extends AbstractGenericListTreeNode<V, N> implements OnOffTreeNodeInterface<N> {
	 ...
	 * @param value
	 */
	public AbstractGenericOnOffListTreeNode(V value) {
		super(value);
