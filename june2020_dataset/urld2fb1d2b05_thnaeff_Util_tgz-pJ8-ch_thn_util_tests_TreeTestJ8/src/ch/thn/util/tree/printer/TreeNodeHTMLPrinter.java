...
import ch.thn.util.tree.printer.generic.HTMLTreePrinter;
 ...
 *
 */
public class TreeNodeHTMLPrinter<N extends CollectionTreeNodeInterface<?, N>>
extends HTMLTreePrinter<N> {
	 ...
	 * @param useColors
	 */
	public TreeNodeHTMLPrinter(boolean alignValuesRight, boolean useColors) {
		super(alignValuesRight, useColors);
