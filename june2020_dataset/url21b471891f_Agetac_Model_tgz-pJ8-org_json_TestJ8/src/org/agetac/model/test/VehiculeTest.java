...
public class VehiculeTest {
	...
	public void jsonTransformNoException() throws Exception {
		Vehicule v1 = new Vehicule("v1", new Position(12.155466,42.5555), CategorieVehicule.FPT, "JanzĂŠ", Vehicule.EtatVehicule.ALERTE, new Groupe("g", null, null), "4242");
		Vehicule v2 = null;
	...
	public void jsonTransformEquality() throws InvalidJSONException, JSONException {
		Vehicule v1 = new Vehicule("v1", new Position(12.155466,42.5555), CategorieVehicule.FPT, "JanzĂŠ", Vehicule.EtatVehicule.ALERTE, new Groupe("g", null, null), "1664");
		Vehicule v2 = null;
