...
public class IntegrationRequestInterserviceMessage extends InterserviceMessage {
	...
	public String toString() {
		return "IntegrationRequestInterserviceMessage";
	}

	@Override
	public int getTypeId() {
		return InterservicePacket.INTEGRATION_REQUEST;
	}

	@Override
	public void callOnReceiveMethod(InterserviceChannel interserviceChannel) {
		interserviceChannel.onReceiveIntegrationRequestInterserviceMessage(this);
	}
