...
public class KeyMaxEncryptionBlockNumBytesRequestMessage extends A2SRevisionSpecificMessage implements KeyMaxEncryptionBlockNumBytesRequestMessageI {
	...
	public String toString() {
		return "KeyMaxEncryptionBlockNumBytesRequestMessage";
	}
	...
	@Override
	public byte getType() {
		return Rev0Message.KEY_MAX_ENCRYPTION_BLOCK_NUM_BYTES_REQUEST;
	}

	@Override
	public void callOnReceiveMethod(A2SMessageReceiver a2sMessageReceiver) {
		a2sMessageReceiver.onReceiveKeyMaxEncryptionBlockNumBytesRequestMessage();
	}
