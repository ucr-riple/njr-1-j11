...
public
class ASTWhileStatement extends SXLNode {
  public ASTWhileStatement(int id) {
    super(id);
  }

  public ASTWhileStatement(SXLParser p, int id) {
    super(p, id);
  }
...
/* JavaCC - OriginalChecksum=66163be381d4982cd8432573b6007016 (do not edit this line) */
