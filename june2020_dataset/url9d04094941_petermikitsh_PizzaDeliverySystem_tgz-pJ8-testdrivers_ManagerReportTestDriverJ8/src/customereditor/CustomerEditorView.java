 ...
 */
public abstract class CustomerEditorView extends GeneralView {
	 ...
	 */
	public enum CustomerEditorInChan implements InputChannel {
	 ...
	 */
	public enum CustomerEditorOutChan implements OutputChannel {
