...
/**
 * Created by mateus on 3/6/14.
 */
public class IsolatedGantt {

    private Task tasks[];
    private String filePath;
    public static String fileName;

    public IsolatedGantt(Task[] tasks, String filePath) {
        this.tasks = tasks;
        this.filePath = filePath;
    }

    public IsolatedGantt() {
    }

    public void generateDiagram() {
        filePath = "gantt/testTime.png";
