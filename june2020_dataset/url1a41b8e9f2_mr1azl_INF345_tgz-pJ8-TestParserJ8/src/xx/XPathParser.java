    ...
    case 88:
      ...
      if (jj_2_3(2147483647)) {
        ...
        jj_consume_token(Literal);
                    instruction = token.image.substring(1, token.image.length() - 1);
        jj_consume_token(81);
      } else {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case OR:
...
/* [9] PredicateExpr ::=  Expr  */
  final public Object Predicate() throws ParseException {
    Object ex;
    compiler.setPredicate(true);
    jj_consume_token(84);
    ex = Expression();
    jj_consume_token(85);
     compiler.setPredicate(false);
        {if (true) return ex;}
    throw new Error("Missing return statement in function");
  }
...
/* [15] PrimaryExpr ::= VariableReference | '(' Expr ')' | Literal | Number | FunctionCall */
  final public Object PrimaryExpr() throws ParseException {
    ...
    case Literal:
      jj_consume_token(Literal);
                      ex = compiler.literal(token.image.substring(1, token.image.length() - 1)) ;
      break;
    case Number:
...
/* [37]    NameTest    ::=    '*'     | NCName ':' '*'     | QName  */
  final public Object NameTest() throws ParseException {
    Object qn;
    String nc1, nc2 = null;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case 88:
