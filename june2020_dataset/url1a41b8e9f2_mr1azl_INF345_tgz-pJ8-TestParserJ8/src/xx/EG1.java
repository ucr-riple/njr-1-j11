...
public class EG1 implements EG1Constants {
  ...
  /** Constructor with InputStream. * @param stream java.io.InputStream
   */
  public EG1(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding * @param stream java.io.InputStream
  ...
  /** Reinitialise. * @param stream java.io.InputStream
   */
  ...
  /** Constructor. * @param stream java.io.Reader
   */
  ...
  /** Reinitialise. * @param stream java.io.Reader
   */
  ...
  /** Constructor with generated Token Manager. * @param tm EG1TokenManager
   */
  ...
  /** Reinitialise. * @param tm EG1TokenManager
   */
...
/** Get the next Token. * @return Token
 */
...
/** Get the specific Token. * @param index int
 * @return Token
 */
  ...
  /** Generate ParseException. * @return ParseException
   */
