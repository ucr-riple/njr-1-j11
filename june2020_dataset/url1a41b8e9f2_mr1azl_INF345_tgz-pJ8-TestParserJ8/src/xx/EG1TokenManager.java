...
public class EG1TokenManager implements EG1Constants
{
  ...
  /** Set debug output. * @param ds java.io.PrintStream
   */
...
/** Constructor. * @param stream SimpleCharStream
 */
...
/** Reinitialise parser. * @param stream SimpleCharStream
 */
...
/** Switch to specified lex state. * @param lexState int
 */
