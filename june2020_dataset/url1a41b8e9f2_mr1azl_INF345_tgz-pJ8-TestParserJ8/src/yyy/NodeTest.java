...
/**
 */
public  class NodeTest  implements Element{
	public short nodeType=0;
	private Step[] steps;
	private String nodeValue=null;
	private List<Node> context;
	private Map<String, NodeTest[]> functionCalls=new HashMap<>();
	...
	public String toString() {
		return "NodeTest [nodeType=" + nodeType + ", steps="
				+ Arrays.toString(steps) + ", getNodeName()=" + getNodeName()
				+ ", getNodeValue()=" + getNodeValue() + ", getNodeType()="
				+ getNodeType() + "]";
	}
	 ...
	 * @return Map<String,NodeTest[]>
	 */
	public Map<String, NodeTest[]> getFunctionCalls() {
		return functionCalls;
	}

	/**
	 * Method setFunctionCalls.
	 * @param functionCalls Map<String,NodeTest[]>
	 */
	public void setFunctionCalls(Map<String, NodeTest[]> functionCalls) {
