...
public interface MessageConsumer {
    ...
    /**
     * A convenient method to simply call
     * {@link #consume(String, String, String[], int, boolean, boolean)} with
     ...
     *            Whether declare this exchange with provided
     *            {@code exchangeName}. In some case, the exchange has been
     *            declared by other system.
     * @param declareQueue
     *            Whether declare the queue by provided {@code queueName}. In
     *            some cases, the queue has been declared by other systems.
     * @throws IOException
