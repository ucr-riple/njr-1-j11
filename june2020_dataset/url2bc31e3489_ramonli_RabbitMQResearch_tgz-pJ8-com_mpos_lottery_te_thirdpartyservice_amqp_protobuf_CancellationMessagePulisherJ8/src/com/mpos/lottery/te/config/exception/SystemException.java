...
public class SystemException extends RuntimeException implements TeException {
    ...
    public static final int CODE_OPERATOR_NOPRIVILEDGE = 225;
    ...
    public static final int CODE_ENROLL_FAIL = 232;
    public static final int CODE_SMART_CARD_IN_BLACKLIST = 233;
    public static final int CODE_UNBIND_SMART_CARD = 234; // bind smart card
                                                          // with saleman
    ...
    public static final int CODE_NO_ACTIVE_DRAW = 304;
    ...
    public static final int CODE_MULTIPLE_PAYOUT = 316;
    public static final int CODE_CANCEL_CANCELED_TICKET = 317;
    public static final int CODE_REVERSED_TRANS = 321;
    public static final int CODE_MULTIPLEDRAW_NEGATIVE = 325;
    public static final int CODE_NO_FUNTYPE = 326;
    ...
    public static final int CODE_MANUAL_SETTLE_BATCH = 352; // lock terminal
                                                            // after manual
                                                            // settlement.
    ...
    /** toto error code ,lee add 2010-04-30 start */
    /** have none match game matchs */
    public static final int CODE_TOTO_NONE_MATCHS = 800;

    /** select team is not match error */
    ...
    /** toto error code ,lee add 2010-04-30 end */

    /** hasp license not support this game */
