...
public class EvolvingGlobalDivisable5Language {
			...
			for (int n = 0; n < 25; n++) {
				...
				for (int i = 0; i < 100; i++) {
					...
					if (starter.getWinner() != null) {
						...
						GraphvizRenderer.renderGraph(starter.getWinner().getObj(), "div5_solution_"+String.valueOf(solutionFoundCounter)+".svg");
