...
/**
 * A data structure to store STAT results
 * 
 */
public class Statistics implements IStatistics, Cloneable {
	...
	public Statistics(Statistics s) {
		...
		m_nodesInLevel = (ArrayList<Integer>) (s.m_nodesInLevel.clone());
	}
	...
	public int getNumberOfNodesInLevel(int l) throws IndexOutOfBoundsException {
		return (m_nodesInLevel.get(l)).intValue();
	}
	...
	public String toString() {
		...
		for (int cLevel = 0; cLevel < m_treeHeight; cLevel++) {
			s += "Level " + cLevel + " pages: " + (m_nodesInLevel.get(cLevel)).intValue() + "\n";
		}
