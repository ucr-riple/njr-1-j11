...
public class Index extends Node {
	...
	@Override
	/**
	 * right id has not been assigned
	 */
	...
	protected void adjustTree(Node n1, Node n2, Stack<Integer> pathBuffer, boolean[] overflowTable) {
		...
		boolean adjusted = insertData(null, (Region) n2.m_nodeMBR.clone(), n2.m_identifier, pathBuffer, overflowTable, null);
	...
	@Override
	protected void drawSelf(Graphics g, double ratio) {
		drawRect(g, m_nodeMBR, COLOR_NODE, ratio, "" + m_identifier, COLOR_TEXT);
		for (int i = 0; i < m_children; i++)
			m_pTree.readNode(m_pIdentifier[i]).drawSelf(g, ratio);
	}
	...
	class OverlapEntryComparator implements Comparator<Object> {
		@Override
