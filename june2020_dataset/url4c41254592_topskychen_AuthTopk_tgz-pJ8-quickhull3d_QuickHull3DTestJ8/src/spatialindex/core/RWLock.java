...
public class RWLock {
	...
	/**
	 * if no one is writing and !write_lock, then allow to read
	 */
	...
	/**
	 * 
	 * @return whether the read_lock is unblock
	 */
	...
	/**
	 * if no one reader is reading, then unblock the read_block and notify
	 * writers
	 */
	...
	/**
	 * if it is safe for write, then return. else wait until it is safe to write
	 */
	...
	/**
	 * 
	 * @return whether the writer_lock is unblock
	 */
	...
	/**
	 * unlock the writer_lock and notify all readers/writers
	 */
