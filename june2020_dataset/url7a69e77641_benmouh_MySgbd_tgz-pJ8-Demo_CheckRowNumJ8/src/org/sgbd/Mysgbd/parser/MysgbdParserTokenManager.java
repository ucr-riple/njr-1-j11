/* Generated By:JavaCC: Do not edit this line. MysgbdParserTokenManager.java */
package org.sgbd.Mysgbd.parser;
import java.io.*;
import java.util.*;

/** Token Manager. */
public class MysgbdParserTokenManager implements MysgbdParserConstants
{
...
/** Constructor. */
public MysgbdParserTokenManager(SimpleCharStream stream){
...
/** Constructor. */
public MysgbdParserTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
