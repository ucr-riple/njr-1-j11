...
/**
 * Primitive representing a signed 4-byte (32 bit) big-endian integer value. 
 * This closely corresponds to java's 'int' value.
 * @author Jim Halliday
 */
public class Int4ByteSignedBE implements Primitive, PrimitiveInt, PrimitiveFixedByte {
	 ...
	 */
	public Int4ByteSignedBE(RandomAccessFile raf) throws IOException, BadValueException {
	 ...
	 */
	public Int4ByteSignedBE(String val) throws BadValueException {
