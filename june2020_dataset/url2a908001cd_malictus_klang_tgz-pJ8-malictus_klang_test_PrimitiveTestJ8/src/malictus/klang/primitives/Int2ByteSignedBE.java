...
/**
 * Primitive representing a signed 2-byte (16 bit) big-endian integer value. 
 * This closely corresponds to java's 'short' value.
 * @author Jim Halliday
 */
public class Int2ByteSignedBE implements Primitive, PrimitiveInt, PrimitiveFixedByte {
	 ...
	 */
	public Int2ByteSignedBE() { }
	
	/**
	 * Constructor from a Short value.
	 * @param value the Short that this object should represent
	 */
	public Int2ByteSignedBE(Short value) {
	 ...
	 */
	public Int2ByteSignedBE(Integer value) throws BadValueException {
	 ...
	 */
	public Int2ByteSignedBE(RandomAccessFile raf) throws IOException, BadValueException {
	 ...
	 */
	public Int2ByteSignedBE(String val) throws BadValueException {
	...
	/**
	 * Set the current value to the specified Short object.
	 * @param value the new Short value
	 * @throws BadValueException if the Short is out of range
	 */
	public void setValue(Short value) throws BadValueException {
		if (!testCandidate(value)) {
			throw new BadValueException(value.toString());
		}
		this.value = value;
	 ...
	 */
	private boolean testCandidate(Short value) {
		//in this case, any short value qualifies!
		return true;
	}
