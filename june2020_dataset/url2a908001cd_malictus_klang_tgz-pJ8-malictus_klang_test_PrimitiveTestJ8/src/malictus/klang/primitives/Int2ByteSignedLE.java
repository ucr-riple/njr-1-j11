...
/**
 * Primitive representing a signed 2-byte (16 bit) little-endian integer value. 
 * @author Jim Halliday
 */
public class Int2ByteSignedLE implements Primitive, PrimitiveInt, PrimitiveFixedByte {
	 ...
	 */
	public Int2ByteSignedLE(Integer value) throws BadValueException {
	 ...
	 */
	public Int2ByteSignedLE(RandomAccessFile raf) throws IOException, BadValueException {
	 ...
	 */
	public Int2ByteSignedLE(String val) throws BadValueException {
	...
	public void writeValueToFile(RandomAccessFile raf) throws IOException, BadValueException {
		...
		Short output = Short.reverseBytes(value);
