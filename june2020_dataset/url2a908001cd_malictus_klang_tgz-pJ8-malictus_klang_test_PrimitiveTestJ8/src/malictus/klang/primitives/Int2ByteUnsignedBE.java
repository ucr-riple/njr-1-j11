...
/**
 * Primitive representing an unsigned 2-byte (16 bit) big-endian integer value. 
 * We will use a java Integer object to represent this value, since java shorts are always signed.
 * @author Jim Halliday
 */
public class Int2ByteUnsignedBE implements Primitive, PrimitiveInt, PrimitiveFixedByte {
	 ...
	 */
	public Int2ByteUnsignedBE(Integer value) throws BadValueException {
	 ...
	 */
	public Int2ByteUnsignedBE(RandomAccessFile raf) throws IOException, BadValueException {
	 ...
	 */
	public Int2ByteUnsignedBE(String val) throws BadValueException {
