...
/**
 * Primitive representing an unsigned 4-byte (32 bit) big-endian integer value.
 ...
 * @author Jim Halliday
 */
public class Int4ByteUnsignedBE implements Primitive, PrimitiveInt, PrimitiveFixedByte {
	 ...
	 */
	public Int4ByteUnsignedBE(Long value) throws BadValueException {
	 ...
	 * @throws BadValueException if given value is out of range
	 */
	public Int4ByteUnsignedBE(Integer value) throws BadValueException {
	 ...
	 */
	public Int4ByteUnsignedBE(RandomAccessFile raf) throws IOException, BadValueException {
	 ...
	 */
	public Int4ByteUnsignedBE(String val) throws BadValueException {
