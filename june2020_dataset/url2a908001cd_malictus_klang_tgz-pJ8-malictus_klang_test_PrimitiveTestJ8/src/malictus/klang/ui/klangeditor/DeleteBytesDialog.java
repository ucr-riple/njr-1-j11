...
/**
 * A DeleteBytesDialog is a helper dialog box for deleting raw bytes from a file.
 * @author Jim Halliday
 */
public class DeleteBytesDialog extends JDialog {
	...
	public DeleteBytesDialog(KlangEditor parent) {
		super(parent);
		this.setModalityType(ModalityType.APPLICATION_MODAL);
		this.setResizable(false);
		this.setTitle(KlangConstants.KLANGEDITOR_DELETEBYTESDIALOG_TITLE);
