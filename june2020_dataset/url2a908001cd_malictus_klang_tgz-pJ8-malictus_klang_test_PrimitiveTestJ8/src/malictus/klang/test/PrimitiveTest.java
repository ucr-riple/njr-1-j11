...
/**
 * A simple test for reading and writing primitive values, including loading the primitives descriptions.
 * Also tests creating a simple PrimitiveData object.
 * When new primitives are added, a test for that type should be added here as well.
 * @author Jim Halliday
 */
public class PrimitiveTest {
	...
	public static void main(String[] args) {
		...
		try {
			...
			//A SIMPLE TEST FOR PrimitiveData OBJECTS
	...
	private static File createTempFile() throws IOException {
		File tempFile = File.createTempFile("klang", ".dat");
		tempFile.deleteOnExit();
		return tempFile;
	}
	
	private static void deleteTempFile(File tempFile) throws IOException {
		tempFile.delete();
		if (tempFile.exists()) {
