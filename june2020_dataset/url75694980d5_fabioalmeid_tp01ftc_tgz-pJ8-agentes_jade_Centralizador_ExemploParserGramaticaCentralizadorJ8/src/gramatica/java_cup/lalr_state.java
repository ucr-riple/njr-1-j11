 ...
 *
 * @see     gramatica.java_cup.lalr_item
 * @see     gramatica.java_cup.lalr_item_set
 * @see     gramatica.java_cup.lalr_transition
...
public class lalr_state {
   ...
   * @see   gramatica.java_cup.lalr_item_set#compute_closure
   * @see   gramatica.java_cup.lalr_state#propagate_all_lookaheads
   */
