...
public class EQuantidade extends Quantidade {
  ...
  public <R,A> R accept(gramatica.Monitor.Absyn.Quantidade.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof gramatica.Monitor.Absyn.EQuantidade) {
      gramatica.Monitor.Absyn.EQuantidade x = (gramatica.Monitor.Absyn.EQuantidade)o;
