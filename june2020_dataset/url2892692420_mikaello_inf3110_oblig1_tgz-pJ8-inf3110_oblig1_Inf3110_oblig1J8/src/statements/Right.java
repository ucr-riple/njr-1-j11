...
/**
 * This moves the robot right. The number of steps it should move
 * right is determined by the expression given as parameter upon
...
public class Right extends Move implements Handler {
    ...
    public String toString() { return "right(" + e + ")"; }
