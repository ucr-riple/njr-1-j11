...
public class SimplexNoise
{
	...
	public static float getOctavedNoise(float x, float y, int octaves, float roughness, float scale)
	{
		float noiseSum = 0;
		...
		{
			noiseSum +=getNoise(x * layerFrequency, y * layerFrequency) * layerWeight;
			layerFrequency *= 2;
