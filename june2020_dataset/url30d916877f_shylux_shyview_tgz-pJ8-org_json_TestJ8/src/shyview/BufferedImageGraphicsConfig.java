...
/*
        ...
        public class BufferedImageGraphicsConfig extends GraphicsConfiguration {
            ...
            public static BufferedImageGraphicsConfig getConfig(
                    BufferedImage bImg) {
            ...
            public BufferedImageGraphicsConfig(BufferedImage bufImg,
                    Component comp) {
                if (comp == null) {
                ...
                this .raster = bufImg.getRaster()
                        .createCompatibleWritableRaster(1, 1);
           ...
           /**
            ...
            public BufferedImage createCompatibleImage(int width, int height) {
                WritableRaster wr = raster.createCompatibleWritableRaster(
                        width, height);
                return new BufferedImage(model, wr, model
            ...
            public ColorModel getColorModel(int transparency) {
                ...
                case Transparency.BITMASK:
                    return new DirectColorModel(25, 0xff0000, 0xff00, 0xff,
                            0x1000000);
